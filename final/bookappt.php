...
<head>
	<meta charset="UTF-8">
    <meta name="description" content="Xeleceem's contact form">
    <meta name="keywords" content="Xeleceem's Contact Form">
	<title>Xeleceem's Contact Form</title>
...
<body>
		...
		<fieldset>
			...
			<label for="appointment_date">Today's  Date:</label>
			<input type="date" name="appointment_date" id="appointment_date" value="<?php echo $_REQUEST['appointment_date'] ?>" disabled><br>
			<label for="subject">Subject:</label>
			<input type="text" name="subject" id="subject" value="<?php echo $_REQUEST['subject'] ?>" disabled><br>
			<label for="Message">Notes:</label>
			<textarea id="message" name="message" rows="4" disabled><?php echo $_REQUEST['message'] ?></textarea><br>
...
<?php
  ...
  //Set admin email for email to be sent to (use you own MATC email address)
    $admin_email = "xiongxc@gmatc.matc.edu"; 
  ...
  //Set PHP variable equal to information completed on the HTML form
    ...
    $reservation_date = $_REQUEST['appointment_date']; //Request subject that user typed on HTML form
  ...
  echo "Thank you for scheduling an appointment!"; 
  }
